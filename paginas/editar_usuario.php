  ...
  <div class="content-wrapper" style="min-height: 942px;">
    ...
    <section class="content">
        ...
        <div class="box box-info">
            ...
            <form class="form-horizontal" action="editar-usuario.php?id=<?=$exibe['user_id'];?>" enctype="multipart/form-data" method="post">
              <div class="box-body">
                  <!--Input Usuário-->
                <div class="form-group">
                    <label for="usuario" class="col-sm-2 control-label">Usuário</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="usuario" name="usuario" value="<?=$exibe["user"]?>">
                  </div>
                </div>
                  <!-- Input Nome do Usuario -->
                  <div class="form-group">
                    <label for="user_name" class="col-sm-2 control-label">Nome do Usuário</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="user_name" name="user_name" value="<?=$exibe["user_name"]?>">
                  </div>
                </div>
                  <!-- Input ID Setor -->
                  <div class="form-group">
                      <label for="setor_id" class="col-sm-2 control-label">ID Setor</label>
                      <div class="col-sm-10">
                          <input type="text" class="form-control" id="setor_id" name="setor_id" value="<?=$exibe["setor_id"]?>">
                      </div>
                  </div>
                <!--Input E-mail-->
                  <div class="form-group">
                      <label for="desc" class="col-sm-2 control-label">E-mail</label>
                      <div class="col-sm-10">
                          <input class="form-control" type="text" id="email" name="email" value="<?=$exibe["user_email"]?>"></input>
                      </div>
                  </div>
                  <!--Input Password-->
                  <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <input class="form-control" type="password" id="password" name="password" value="<?=$exibe["user_password"]?>"></input>
                      </div>
                  </div>
