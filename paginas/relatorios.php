        ...
        <section class="content">
            ...
            <div class="box box-warning box-solid">
                <div class="box-header with-border ui-sortable-handle" style="cursor: move;">
                    <h3 class="box-title">Selecione o Relatório</h3>
                ...
                <div class="box-body" style="">
                    <table class="table table-striped">
                        <tr>
                            <td><a href="../back/relatoriopdf.php"><button type="button" class="btn-lg btn-success">Todos - Exporta para PDF</button></a></td>
                        </tr>
                        <tr>
                            <td><a href="gerar_planilha.php"><button type="button" class="btn-lg btn-success">Todos - Exportar para Excel</button></a></td>
                        </tr>
                    </table>
                </div>
                <!-- /.box-body -->
