...
<li>
  ...
  <div class="content-wrapper" style="min-height: 942px;">
    ...
    <section class="content-header">
      <h1>Descrição<small>Contratos</small>
      </h1>
      <ol class="breadcrumb">
      ...
      <!-- Default box -->
        ...
        <div class="box box-info">
            ...
            <div class="box-header with-border">
              ...
              <h3 class="box-title"><?= $exibe["numero"] ?> - <?= $exibe["titulo"] ?></h3>
            </div>
            <div class="row">
    ...
    <tbody>
        ...
        <?php
        $path = "../upload/" . $exibe["diretorio"] . "/";
        $diretorio = dir($path);
        while($arquivo = $diretorio -> read()){
        if (($arquivo==".")||($arquivo=="..")) continue;
        echo "<tr>";
        echo "<td><center><a href='".$path.$arquivo."'>".$arquivo."</a></center></td>";
        echo "<form method='post' action='excluirc.php'>";
        echo "<input type='hidden' value='".$exibe["contrato_id"]."' name='id' id='id'>";
        echo "<input type='hidden' value='".$path.$arquivo."' name='arquivo' id='arquivo'>";
        echo "<td><center><button type='submit' class=\"btn btn btn-danger\"><i class=\"fa fa-fw fa-trash\"></i></button></center></td>";
        echo "</form></tr>";    
        };
        $diretorio -> close();
        ...
        ?>
           ...
           echo "<td><i class=\"fa fa-circle-o text-red\"></i> <span>Expirado</span></td>";
            ...
            <br>
                   <div class="row">
            <div class="col-sm-4" style="">
                <h4><b>    Valor:</b> R$ <?= $exibe["valor"] ?></h4>
                
            </div>
            <div class="col-sm-8" style="border">
            <h4><b>Vencimento:</b></h4>
                <h4><?= date('d/m/Y', strtotime($exibe['vencimento'])) ?></h4>
            </div>
            </div>
          </div>
        <?php }; ?>
