...
$querry = "select * from contratos where setor_id= {$setor}";
...
<body class="skin-blue sidebar-mini wysihtml5-supported" style="height: auto; min-height: 100%;"><div id="StayFocusd-infobar" style="display:none;">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="../#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?=$_SESSION['nome_usuario']?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
...
<li>
  ...
  <div class="content-wrapper" style="min-height: 942px;">
    ...
    <section class="content-header">
      <h1>Contratos Do Setor<small>Contratos</small>
      </h1>
      <ol class="breadcrumb">
    ...
    while($exibe = mysqli_fetch_assoc($resultado)){ ?>
        ...
        <div class="modal modal-danger fade in" id="modal-danger<?=$exibe['contrato_id']?>">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p>Você está prestes a exlcuir um contrato, tem certeza que deseja realizar esta ação?</p>
              </div>
              <div class="modal-footer">
                <form method="post" action="excluir.php">
                    <input type="hidden" value="<?=$exibe['contrato_id'];?>" name="id" id="id">
                    <button class="btn btn-outline pull-left" data-dismiss="modal">Não</button>
    ...
    <?php
      ...
      echo "<td><a href=\"contrato.php?id={$exibe["contrato_id"]}\">" . $exibe["titulo"] . "</a></td>";
      echo "<td>" . date('d/m/Y', strtotime($exibe['inicio'])) . " - " . date('d/m/Y', strtotime($exibe['vencimento'])) . "</td>";
      if (strtotime($exibe["vencimento"]) > strtotime($hoje)){
           echo "<td><i class=\"fa fa-circle-o text-green\"></i> <span>Contrato Vigente</span></td>";
       } else {
           echo "<td><i class=\"fa fa-circle-o text-red\"></i> <span>Contrato Vencido</span></td>";
       }
      echo "<td>{$exibe["gestor"]}</td>";
      echo "<td><div class=\"row\">
      <form method=\"post\" action=\"editar.php\">
      <input type=\"hidden\" value=\"{$exibe["contrato_id"]}\" name=\"id\">
      <button type=\"submit\" class=\"btn btn btn-info \" style=\"width: 40px;\"><i class=\"ion-edit\"></i></button>
      
      ";
    
      echo "<button type=\"button\" data-toggle=\"modal\" data-target=\"#modal-danger{$exibe['contrato_id']}\" class=\"btn btn btn-danger\" style=\"width: 40px;\"><i class=\"ion-trash-a\"></i></button></div></td>";
      echo "</form></tr>";
     }     
    ?>    
    </tbody>
