...
$querry2 = "select * from usuarios";
$resultado2 = mysqli_query($conexao, $querry2);
...
<li>
  ...
  <div class="content-wrapper" style="min-height: 942px;">
    ...
    <section class="content-header">
      <h1>Usuários do sistema<small>Usuários</small>
      </h1>
      <ol class="breadcrumb">
    ...
    while($exibe = mysqli_fetch_assoc($resultado)){ ?>
        ...
        <div class="modal modal-danger fade in" id="modal-danger<?=$exibe['user_id']?>">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p>Você está prestes a excluir um Usuário, tem certeza que deseja realizar esta ação?</p>
              </div>
              <div class="modal-footer">
                <form method="post" action="excluiru.php">
                    <input type="hidden" value="<?=$exibe['user_id'];?>" name="id" id="id">
    ...
    <?php
      echo "<tr>";
      echo "<td>{$exibe["user_id"]}</td>";
      echo "<td>{$exibe["user"]}</td>";
      echo "<td>{$exibe["user_name"]}</td>";
      echo "<td>{$exibe["setor_id"]}</td>";
        echo "<td>{$exibe["user_email"]}</td>";
      echo "<td><div class=\"row\">
      <form method=\"post\" action=\"editar-usuario.php\">
      <input type=\"hidden\" value=\"{$exibe["user_id"]}\" name=\"id\">
      <button type=\"submit\" class=\"btn btn btn-info \" style=\"width: 40px;\"><i class=\"ion-edit\"></i></button>
      
      ";

      echo "<button type=\"button\" data-toggle=\"modal\" data-target=\"#modal-danger{$exibe['user_id']}\" class=\"btn btn btn-danger\" style=\"width: 40px;\"><i class=\"ion-trash-a\"></i></button></div></td>";
      echo "</form></tr>";
     }
    ?>
    </tbody>
