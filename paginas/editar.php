...
$id = $_POST["id"];
$query = "select * from contratos where contrato_id= {$id}";
...
<li>
  ...
  <div class="content-wrapper" style="min-height: 942px;">
    ...
    <section class="content-header">
      <h1>Editar Contrato<small>Contratos</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      ...
      <div class="alert alert-info alert-dismissible">
        ...
        <div class="box box-info">
            ...
            <form class="form-horizontal" action="editar-contrato.php?id=<?=$exibe['contrato_id'];?>" enctype="multipart/form-data" method="post"> 
              <div class="box-body">
                  <!--Input Titulo-->
                <div class="form-group">
                    <label for="titulo" class="col-sm-2 control-label">Titulo</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="titulo" placeholder="Titulo" name="titulo" value="<?=$exibe["titulo"]?>">
                  </div>
                </div>
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="numero" placeholder="000/0000" name="numero" value="<?=$exibe["numero"]?>">
                  </div>
                </div>
                  <!-- Input Numero proton -->
                  <div class="form-group">
                      <label for="numeroproton" class="col-sm-2 control-label">Numero Proton</label>
                      <div class="col-sm-10">
                          <input type="text" class="form-control" id="numeroproton" placeholder="0000000" name="numeroproton" value="<?=$exibe["numeroproton"]?>">
                      </div>
                  </div>
            <!--Input Descrição-->
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" rows="3" placeholder="Descrição ..." id="desc" name="descricao"><?=$exibe["descricao"]?></textarea>
                  </div>
                </div>
                  <!--Input Tempo indeterminado-->
                  <? if($exibe['tempoindeterminado'] == 1) $value="checked"; ?>
                  <div class="form-group">
                      <label for="tempo_indeterminado" class="col-sm-2 control-label">Tempo Indeterminado: </label><input type="checkbox" name="tempo_indeterminado" value="<?=$exibe["tempoindeterminado"]?>" onclick="venci.disabled=this.checked;alerta_pagamento.disabled=this.checked;email_pagamento.disabled=this.checked;repetir.disabled=this.checked;">
                  ...
                  <div class="col-sm-10">
                    <input type="date" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="" id="inicio" name="inicio" value="<?=$exibe["inicio"]?>">
                  </div>
                </div>    
                  <!--Input Vencimento-->
                  <div class="form-group">
                  <label for="venci" class="col-sm-2 control-label">Data de vencimento</label>

                  <div class="col-sm-10">
                    <input type="date" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="" id="venci" name="venci" value="<?=$exibe["vencimento"]?>">
                  </div>
                </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <input type="date" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="" id="pagamento" name="pagamento" value="<?=$exibe["pagamento"]?>">
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-2">
                          <input type="date" class="col-sm-4 form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="" id="alerta_contrato" name="alerta_contrato" value="<?=$exibe["alerta_contrato"]?>">
                      </div>
                      <label for="emailContrato" class="col-sm-4 control-label">E-mail para envio do Alerta de Contratos: </label>
                      <div class="col-sm-3">
                          <input type="email" class="form-control" id="email_contrato" name="email_contrato" value="<?=$exibe["email_contrato"]?>">
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-2">
                          <input type="date" class="col-sm-4 form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="" id="alerta_pagamento" name="alerta_pagamento" value="<?=$exibe["alerta_pagamento"]?>">
                      ...
                      <div class="col-sm-3">
                          <input type="email" class="form-control" id="email_pagamento" name="email_pagamento" value="<?=$exibe["email_pagamento"]?>">
                      </div>
                  </div>
                ...
                <input type="number" class="form-control" id="valor" name="valor" value="<?=$exibe["valor"]?>">
