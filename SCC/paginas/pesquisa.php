...
$query = "SELECT * FROM contratos WHERE titulo LIKE '%".$q."%' ORDER BY titulo";
...
<li>
  ...
  <div class="content-wrapper" style="min-height: 942px;">
    ...
    <section class="content-header">
      <h1>Resultado da Pesquisa<small>Contratos</small>
      </h1>
      <ol class="breadcrumb">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright © 2018 <a href="../http://facebook.com/">UNINF</a>.</strong>Todos os direitos reservados</footer>
