      ...
      <!-- Default box -->
        ...
        <div class="box box-warning box-solid">
            <div class="box-header with-border ui-sortable-handle" style="cursor: move;">
              <h3 class="box-title">Selecione a Configuração</h3>
         ...
         <table class="table table-striped">
                <tr>
                    <td><a href="../back/registrar.php"><button type="button" class="btn-lg btn-success">Incluir Usuários</button></a></td>
                    <td><a href="listar_usuarios.php"><button type="button" class="btn-lg btn-success">Editar Usuários</button></a></td>
                </tr>
         </table>
            </div>
            <!-- /.box-body -->
