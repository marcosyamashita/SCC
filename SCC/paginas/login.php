...
<div class="register-box">
  <div class="register-logo">
      <a href="http://www.sicoobcrediembrapa.com.br/" target="_blank"><img src="../dist/img/logo.png" class="logo-sicoob"><p class="logo-crediembrapa"><p class="logo-crediembrapa"></p></a>
  </div>

  <div class="register-box-body">
    <p class="login-box-msg">Logar-se</p>
    ...
    <?php if ( ! empty( $_SESSION['login_erro'] ) ) :?>
      <span style="color: red"><?php echo $_SESSION['login_erro'];?></span>
    ...
    <!--<a href="../back/registrar.php" class="text-center">Cadastrar Novo Usuario</a> -->
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
