...
<div class="wrapper" style="height: auto; min-height: 100%;">
    ...
    <div class="content-wrapper" style="min-height: 942px;">
        ...
        <section class="content-header">
            <h1>Editar Usuário<small>Usuários</small>
            </h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
            ...
            <div class="alert alert-info alert-dismissible">
                ...
                <h4><i class="icon fa fa-info"></i> Alerta!</h4>Atenção com o preenchimento dos campos!</div>
            <!-- FORMULARIO REGISTRO NOVO USUARIO -->
            <div class="box box-info">
                ...
                <?php while($exibe = mysqli_fetch_assoc($resultado)){ ?>
                    ...
                    <form class="form-horizontal" action="config-usuario.php?id=<?=$exibe['user_id'];?>" enctype="multipart/form-data" method="get">
                        <div class="box-body">

                            <!-- Avatar-->
                            <div class="form-group circle">
                                <label class="col-sm-1 control-label">Selecione o Avatar: </label>
                                <label>
                                    <input type="radio" name="avatar" value="../dist/img/avatar1.jpg" checked>
                                    <img src="../dist/img/avatar1.jpg" style="border-radius: 50%; height: 20%; width: 52%">
                                </label>

                                <label>
                                    <input type="radio" name="avatar" value="../dist/img/avatar2.png">
                                    <img src="../dist/img/avatar2.png" style="border-radius: 50%; height: 20%; width: 52%">
                                </label>

                                <label>
                                    <input type="radio" name="avatar" value="../dist/img/avatar3.png">
                                    <img src="../dist/img/avatar3.png" style="border-radius: 50%; height: 20%; width: 52%">
                                </label>

                                <label>
                                    <input type="radio" name="avatar" value="../dist/img/avatar4.png">
                                    <img src="../dist/img/avatar4.png" style="border-radius: 50%; height: 20%; width: 52%">
                                </label>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="user_id" placeholder="ID Usuario" name="user_id" value="<?=$exibe["user_id"]?>" readonly>
                                </div>
                            </div>
                            <!-- Input Nome Usuário -->
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                        <input type="text" class="form-control" id="user" placeholder="Nome Usuário" name="user" value="<?=$exibe["user"]?>">
                                </div>
                            </div>
                            <!--Input Nome Completo -->
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="user_name" placeholder="Nome Completo"  name="user_name" value="<?=$exibe["user_name"]?>">
                                </div>
                            </div>
                            <!-- Input E-mail -->
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="user_email" placeholder="E-mail" name="user_email" value="<?=$exibe["user_email"]?>">
                                </div>
                            </div>
                            <!--Input Setor -->
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="setor_id" placeholder="Setor ID" name="setor_id" value="<?=$exibe["setor_id"]?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="password" class="form-control" id="user_password" name="user_password" value="<?=$exibe["user_password"]?>">
                                </div>
                            </div>
                        </div>
                        <!-- /.box-body -->
